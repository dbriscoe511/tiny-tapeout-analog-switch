...
C {devices/iopin.sym} 90 130 2 0 {name=p4 lab=SW_PLUS}
C {devices/iopin.sym} 440 140 0 0 {name=p5 lab=SW_MINUS}
C {devices/lab_wire.sym} -100 130 0 0 {name=p6 sig_type=std_logic lab=nSW_ON}
